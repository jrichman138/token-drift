...
// Used for spacing, fontSize, and radius. The spec calls for exact match with
// rem↔px normalized at the root font size, so there is no near-match band:
// values are either an exact match or an orphan.
