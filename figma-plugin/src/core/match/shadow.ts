...
// Component-wise match: ±1px on each dimension and ΔE 2.0 on color; any component
// out of tolerance makes it an orphan. v1 handles single shadows; multi-shadow
// values (comma-separated) are treated as not comparable.
...
// Recognize both legacy and modern CSS color serializations.
const COLOR_PATTERN =
